...
nombre = 'Letra_Z'
direccion = 'D:/Datos/Desktop/CODIGOS/TESISFINAL/DATAJIMMY'
...
while True:
    ...
    if mano == 1:
        ...
        cv2.imwrite(carpeta + "/Z_INVESTIGADORJIMMY_{}.jpg".format(cont), recorte)

        #Aumentar contador
        cont += 1
        cv2.imshow("Reconocer Mano", recorte)
